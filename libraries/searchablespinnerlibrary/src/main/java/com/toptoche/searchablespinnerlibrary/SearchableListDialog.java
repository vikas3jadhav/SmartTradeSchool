...
public class SearchableListDialog extends DialogFragment implements
    ...
    private SearchableItem _searchableItem,_searchableItemimg;
    ...
    public static SearchableListDialog newInstance(List items, List _image_items) {
        SearchableListDialog multiSelectExpandableFragment = new SearchableListDialog();

        Bundle args = new Bundle();
        args.putSerializable(ITEMS, (Serializable) items);
        args.putSerializable(IMAGE, (Serializable) _image_items);
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if (null != savedInstanceState) {
            ...
            _searchableItemimg = (SearchableItem) savedInstanceState.getSerializable("image");
        }
        // Change End
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putSerializable("image", _searchableItemimg);
    ...
    private void setData(View rootView) {
        ...
        List image = (List) getArguments().getSerializable(IMAGE);

        _listViewItems = (ListView) rootView.findViewById(R.id.listItems);

        //create the adapter by passing your ArrayList data
        listAdapter = new ArrayAdapter(getActivity(), android.R.layout.simple_list_item_1,items);
     //     listAdapter = new SpinnerAdapterPic(getActivity(), R.layout.spinner_value_layout,items);
