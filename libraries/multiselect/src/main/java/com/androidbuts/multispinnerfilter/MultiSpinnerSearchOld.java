...
public class MultiSpinnerSearchOld extends AppCompatSpinner implements OnCancelListener {
    ...
    public MultiSpinnerSearchOld(Context context) {
        super(context);
    }

    public MultiSpinnerSearchOld(Context arg0, AttributeSet arg1) {
        super(arg0, arg1);
    ...
    public MultiSpinnerSearchOld(Context arg0, AttributeSet arg1, int arg2) {
    ...
    public class MyAdapter extends BaseAdapter implements Filterable {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            /*if(position%2 == 0){
                ...
                holder.sectiontext.setText("Test" + position);
            }
            else{
