...
public class SingleSpinnerSearchDepartment extends AppCompatSpinner implements OnCancelListener {
    ...
    private List<DepartmentSelectionData> departmentSelectionDataList;
    ...
    public SingleSpinnerSearchDepartment(Context context) {
        super(context);
    }

    public SingleSpinnerSearchDepartment(Context arg0, AttributeSet arg1) {
        super(arg0, arg1);
    ...
    public SingleSpinnerSearchDepartment(Context arg0, AttributeSet arg1, int arg2) {
    ...
    public boolean performClick() {
        ...
        View view = inflater.inflate(R.layout.alert_dialog_listview_single_search, null);
        builder.setView(view);

        final ListView listView = (ListView) view.findViewById(R.id.alertSearchListView);
        listView.setChoiceMode(ListView.CHOICE_MODE_SINGLE);
        listView.setFastScrollEnabled(false);
        adapter = new MyAdapter(getContext(), items, departmentSelectionDataList);
    ...
    public void setItems(List<KeyPairBoolData> items, int position, SpinnerListener listener,
                         List<DepartmentSelectionData> departmentSelectionDataList, List<Integer> shift_position_list) {


        this.departmentSelectionDataList = departmentSelectionDataList;
    ...
    public class MyAdapter extends BaseAdapter implements Filterable {
        ...
        List<DepartmentSelectionData> departmentSelectionDataList;
        List<KeyPairBoolData> arrayList;
        List<KeyPairBoolData> mOriginalValues; // Original Values
        LayoutInflater inflater;

        public MyAdapter(Context context, List<KeyPairBoolData> arrayList, List<DepartmentSelectionData> departmentSelectionDataList) {
            this.departmentSelectionDataList = departmentSelectionDataList;
...
/*
            ...
            final DepartmentSelectionData departmentSelectionData = departmentSelectionDataList.get(position);

            holder.sectiontext.setText(departmentSelectionDataList.get(position).getDepartment());
            ...
            convertView.setOnClickListener(new OnClickListener()
            {
                public void onClick(View v)
                {
                    ...
                    ad.dismiss();
                    SingleSpinnerSearchDepartment.this.onCancel(ad);
                }
            });
