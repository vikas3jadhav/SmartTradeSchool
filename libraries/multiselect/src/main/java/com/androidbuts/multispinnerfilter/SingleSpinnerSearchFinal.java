...
public class SingleSpinnerSearchFinal extends AppCompatSpinner implements OnCancelListener {
    private static final String TAG = SingleSpinnerSearchFinal.class.getSimpleName();
    ...
    public SingleSpinnerSearchFinal(Context context) {
        super(context);
    }

    public SingleSpinnerSearchFinal(Context arg0, AttributeSet arg1) {
        super(arg0, arg1);
    ...
    public SingleSpinnerSearchFinal(Context arg0, AttributeSet arg1, int arg2) {
...
/*    public int getSelectedItemPosition(){
        ...
        for (int i = 0; i < items.size(); i++) {
            if (items.get(i).isSelected()) {
                Log.i("singleselect", i + " : " + items.get(i).getName() + " : " + items.get(i).isSelected());
                pos = i;
            }
        }
        return pos;
...
/*
            ...
            convertView.setOnClickListener(new OnClickListener()
            {
                public void onClick(View v)
                {
                    ...
                    ad.dismiss();
                    SingleSpinnerSearchFinal.this.onCancel(ad);
                }
            });
